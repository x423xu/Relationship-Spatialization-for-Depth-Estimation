...
_C.DATASET.PATH = "../../data/visual-genome"
...
_C.MODEL.WEIGHT_SGG = "./models/sg_baseline_step_ckpt.pth"    # weight loading path for scene graph generator pre-trained model
...
# Use freq bias
_C.MODEL.ROI_RELATION_HEAD.USE_GT_BOXES = True
# Dilation

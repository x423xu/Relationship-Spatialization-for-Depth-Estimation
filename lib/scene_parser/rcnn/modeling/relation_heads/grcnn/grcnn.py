...
class GRCNN(nn.Module):
    ...
    def forward(self, features, proposals, proposal_pairs, export = False):
        ...
        '''relation feature save'''
        x_pred_out = x_pred.detach().clone()
        ...
        if export:
            return (x_pred_out), obj_class_logits, pred_class_logits, obj_class_labels, rel_inds
